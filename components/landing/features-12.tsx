...
export default function Features() {
    ...
    return (
        <section id="recursos" className="py-16 md:py-24">
            <div className="bg-linear-to-b absolute inset-0 -z-10 sm:inset-6 sm:rounded-b-3xl dark:block dark:to-[color-mix(in_oklab,var(--color-slate-900)_75%,var(--color-background))]"></div>
            <div className="mx-auto max-w-6xl space-y-8 px-6 md:space-y-16 lg:space-y-20 dark:[--color-border:color-mix(in_oklab,var(--color-white)_10%,transparent)]">
                <div className="relative z-10 mx-auto space-y-6 text-center">
                    <h2 className="text-balance text-4xl font-semibold lg:text-5xl">{CONTENT.features.title}</h2>
                    <p className="text-lg text-muted-foreground">{CONTENT.features.description}</p>
                </div>
                ...
                <div className="grid gap-12 sm:px-12 md:grid-cols-2 lg:gap-20 lg:px-0">
                    ...
                    <div className="bg-background relative flex overflow-hidden rounded-3xl border p-2">
                        ...
                        <div className="bg-background relative w-[calc(3/4*100%+3rem)] rounded-2xl">
